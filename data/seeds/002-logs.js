  ...
  return knex('logs').truncate()
    .then(function () {
      ...
      return knex('logs').insert([
        ...
        {id: 4, name: 'logName4', description: "Clear waters", duration: "2h 48m", bait: "streamer", num_catch: 0, species: "Sunfish", photo_url: "https://media.istockphoto.com/photos/fishing-concepts-picture-id664304800?k=6&m=664304800&s=612x612&w=0&h=ROFo47Oot_zqg8SOLgj_3hZ0a8RpsfGfQhdC3zYqUeA=", user_id: 1, area_id: 4}
      ]);
    });
};
