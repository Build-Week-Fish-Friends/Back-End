  ...
  return knex('logs').truncate()
    .then(function () {
      ...
      return knex('logs').insert([
        ...
        {name: 'Nap Spot', description: "Nice shade spot", duration: "3h 35m", bait: "Dry Bait", num_catch: 0, species: "Croppie", photo_url: "https://media.istockphoto.com/photos/fishing-concepts-picture-id664304800?k=6&m=664304800&s=612x612&w=0&h=ROFo47Oot_zqg8SOLgj_3hZ0a8RpsfGfQhdC3zYqUeA=", user_id: 1, area_id: 2},
        ...
        {name: 'Quieter Lak', description: "Clear waters", duration: "2h 48m", bait: "streamer", num_catch: 7, species: "Sunfish", photo_url: "https://media.istockphoto.com/photos/fishing-concepts-picture-id664304800?k=6&m=664304800&s=612x612&w=0&h=ROFo47Oot_zqg8SOLgj_3hZ0a8RpsfGfQhdC3zYqUeA=", user_id: 2, area_id: 4}
      ]);
    });
};
